...
// SOP (Standard Operating Procedures) data
const sops = [
  {
    id: 1,
    name: 'High Priority Lead Processing',
    description: 'Comprehensive process for handling high-priority leads',
    type: 'workitem',
    workitemType: 'Lead',
    status: 'Active',
    conditions: [
    ...
    steps: [
      {
        ...
        description: 'Respond to lead within 15 minutes',
        type: 'manual',
        mandatory: true,
        assigneeType: 'role',
        assigneeValue: 'Sales Representative',
        timeframe: 15,
      ...
      },
      {
        ...
        description: 'Qualify lead using BANT criteria',
        type: 'manual',
        mandatory: true,
        assigneeType: 'role',
        assigneeValue: 'Sales Representative',
      ...
      },
      {
        ...
        description: 'Conduct technical assessment with solutions architect',
        type: 'manual',
        mandatory: false,
        assigneeType: 'role',
        assigneeValue: 'Solutions Architect',
        timeframe: 1,
        timeframeUnit: 'days',
      ...
      },
      {
        ...
        description: 'Get manager approval for pricing and terms',
        type: 'approval',
        mandatory: true,
        assigneeType: 'role',
        assigneeValue: 'Sales Manager',
        timeframe: 1,
        timeframeUnit: 'days',
        prerequisites: ['step_4'],
        approvalCriteria: 'Pricing within approved discount limits'
      },
      {
        id: 'step_6',
        name: 'Follow-up Sequence',
        description: 'Execute follow-up sequence if no immediate response',
        type: 'automated',
        mandatory: false,
        timeframe: 7,
        timeframeUnit: 'days',
        prerequisites: ['step_5'],
        automation: 'Email sequence with 3 follow-ups over 2 weeks'
      }
    ],
  ...
  },
  {
    ...
    description: 'Standard onboarding procedure for new customers',
    type: 'contact',
    ...
    steps: [
      {
        ...
        mandatory: true,
        assigneeType: 'role',
        assigneeValue: 'Customer Success Manager',
        timeframe: 1,
        timeframeUnit: 'hours',
        checklist: [
          'Send welcome email with login credentials',
          'Provide setup guide and tutorials',
      ...
      },
      {
        ...
        description: 'Conduct initial setup and training call',
        type: 'manual',
        mandatory: true,
        assigneeType: 'role',
        assigneeValue: 'Customer Success Manager',
      ...
      },
      {
        ...
        description: 'Conduct comprehensive training session',
        type: 'manual',
        mandatory: true,
        assigneeType: 'role',
        assigneeValue: 'Training Specialist',
        timeframe: 1,
        timeframeUnit: 'weeks',
        prerequisites: ['onboard_2'],
        checklist: [
          'User training on core features',
          'Admin training for power users',
      ...
      },
      {
        ...
        description: 'Follow up after 30 days of usage',
        type: 'manual',
        mandatory: false,
        assigneeType: 'role',
        assigneeValue: 'Customer Success Manager',
  ...
  },
  {
    ...
    description: 'Process for handling critical customer issues',
    type: 'workitem',
    workitemType: 'Grievance',
    status: 'Active',
    conditions: [
      { field: 'type', operator: 'equals', value: 'Grievance' },
      { field: 'priority', operator: 'equals', value: 'High' }
    ],
    conditionLogic: 'AND',
    steps: [
      {
        ...
        description: 'Acknowledge issue within 5 minutes',
        type: 'manual',
        mandatory: true,
        assigneeType: 'role',
        assigneeValue: 'Support Manager',
        timeframe: 5,
        timeframeUnit: 'minutes',
        checklist: [
      ...
      },
      {
        ...
        mandatory: true,
        assigneeType: 'role',
        assigneeValue: 'Development Team',
        timeframe: 4,
        timeframeUnit: 'hours',
        prerequisites: ['critical_2'],
        checklist: [
          'Deploy hotfix or workaround',
...
const App: React.FC = () => {
  ...
  const SettingsScreen = () => {
    const settingsTabs = [
      { id: 'general', label: 'General', icon: 'settings' },
      { id: 'fields', label: 'Field Configuration', icon: 'fields' },
      { id: 'sops', label: 'SOP Configuration', icon: 'workflow' },
      { id: 'team', label: 'Team Management', icon: 'team' },
      { id: 'integrations', label: 'Integrations', icon: 'integration' },
      { id: 'notifications', label: 'Notifications', icon: 'bell' },
      { id: 'security', label: 'Security', icon: 'shield' },
